...
import { X, Send, Phone, Mail, User, MessageCircle, ChevronDown } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-y-auto max-h-[90vh] border border-tsuru-blue/10"
          >
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full py-4 bg-tsuru-navy text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-tsuru-navy/90 shadow-xl shadow-tsuru-navy/10 transition-all"
              >
